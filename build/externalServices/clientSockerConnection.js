...
var ClientSocketConnection = /** @class */ (function () {
    ...
    ClientSocketConnection.prototype.eventHandler = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var splittedMessage, Securitykey, decryptMessage, _i, splittedMessage_1, msg, messageInfo, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        splittedMessage = message.split('|');
                        Securitykey = splittedMessage[splittedMessage.length - 1];
                        decryptMessage = [];
                        for (_i = 0, splittedMessage_1 = splittedMessage; _i < splittedMessage_1.length; _i++) {
                            msg = splittedMessage_1[_i];
                        ...
                        return [4 /*yield*/, this.insertMessageInDB(messageInfo)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
